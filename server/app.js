...
// Database Connection
mongoose
  .connect('mongodb+srv://hastipatel8484:hastipatel@8484@ecommercedata.icobp.mongodb.net/ecommerce', {
  ...
  .then(() =>
    console.log(
      "==============Mongodb Database Connected Successfully==============", process.env.DATABASE
    )
  )
  .catch((err) => console.log("Database Not Connected !!!", process.env.DATABASE));
